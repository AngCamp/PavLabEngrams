...
for (i in c(0:3)){
  ...
  print(mrks[which(mrks %in% Jeager.DEGs$GeneID)])
...
```
So I am observing the Penk and Cck seperation that has been described previously (Erwin et al., 2020) and it is happening 
