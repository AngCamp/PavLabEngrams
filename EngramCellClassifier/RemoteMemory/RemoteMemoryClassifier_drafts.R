################
##############
###########   Remote Memory Signature on Kwon et al., (2021)



kwon.glut.idx <- kwon2021_mpfc.combined.sct@meta.data$integrated_snn_res.0.03 %in% c(0,1,4,2)

kwon2021.glut_counts <- kwon2021_counts[,kwon.glut.idx]
